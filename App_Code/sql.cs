...
using System.Web.UI.WebControls;
   ...
   public class sql
    {
       String conexion = "Data Source=localhost;Initial Catalog=bd_AdopcionAnimal;Integrated Security=True; User ID=marco; Password=qwerty12358; MultipleActiveResultSets=True";
        SqlConnection con;
        SqlCommand sqlcm;
        SqlDataReader sqldr;
